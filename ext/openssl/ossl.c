...
build_params_i(RB_BLOCK_CALL_FUNC_ARGLIST(i, memo))
{
    ...
    switch (p->data_type) {
      ...
      default:
        /*
         * Not supported types as of OpenSSL 3.6:
         * - OSSL_PARAM_UTF8_PTR
         * - OSSL_PARAM_OCTET_PTR
         *
         * These are passed by reference and the caller must ensure that the
         * data is alive while the OSSL_PARAM array is used. Currently, no
         * interesting algorithm uses these types in settable OSSL_PARAMs.
         */
