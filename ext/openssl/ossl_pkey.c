...
ossl_pkey_read_generic(BIO *bio, VALUE pass)
{
    ...
    while (!OSSL_STORE_eof(ctx)) {
         ...
         *     -----END EC PRIVATE KEY-----
         *
         * OpenSSL::PKey.read normally expects a single decodable PEM block to
         * appear in the string, but this is seen in the wild and we don't want
